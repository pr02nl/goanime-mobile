...
class NetflixTheme {
  ...
  static LinearGradient get gradientOverlay {
    return const LinearGradient(
      ...
      colors: [Colors.transparent, Colors.transparent, overlay, background],
  ...
  /// Helper method to get horizontal padding based on screen width
  ...
  /// Helper method to get card spacing based on screen width
